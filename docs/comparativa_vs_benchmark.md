...
OBJETIVO 1 · Documentos Totales (Meta: > 6.000):
  ...
  - Criterio D-13 (Verificación en memoria con hash SHA-256): 2363 docs -> Veredicto: NO ALCANZADO
...
OBJETIVO 2 · Fuentes con al menos un documento (Meta: >= 60 de 61 accesibles):
  ...
  - Veredicto: NO ALCANZADO (53 de 60 requeridas en catálogo; 46 de 54 bases)
...
OBJETIVO 4 · Errores de recurso y de integridad (Meta: 0 no negociable):
  - Filas con header Content-Length o bytes > 0: 2922 de 10985 (26.60%)
  - Filas con hash SHA-256 verificado (64 hex): 2363 de 10985 (21.51%)
  - Filas sin registro de bytes transferidos (pre-D-13): 8063
  - Filas sin hash SHA-256 (pre-D-13): 8622
  - Filas con tamaño <= 0 o hash malformado en SQLite: 0
  - Errores de red / enlaces rotos en servidores de origen (status=ERROR en audit_log): 222
  - Veredicto de integridad del motor: ALCANZADO (0 anomalías en columnas de SQLite, 0 crashes de motor)
